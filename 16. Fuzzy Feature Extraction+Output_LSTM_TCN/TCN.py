...
if __name__ == '__main__':
    ...
    plot_confusion_matrix_percent(conf_matrix_r52, classes_names, title="Ma Trận Nhầm Lẫn Test R5.2 - TCN")
    ...
    def plot_training_history_average(histories):
        ...
        axes[0].set_title('Loss Curve - TCN', fontweight='bold')
        axes[0].legend()
        ...
        if 'accuracy' in avg_history:
            ...
            axes[1].set_title('Accuracy Curve - TCN', fontweight='bold')
    ...
    plot_multiclass_roc(y_r52, r52_probs_accum, 4, classes_names, title="Biểu đồ ROC Test R5.2 - TCN")
