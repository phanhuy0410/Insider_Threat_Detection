...
# ==============================================================================
# 🧠 CÁC LỚP ENCODER (THIẾT KẾ PHỄU + ALPHA FOCAL LOSS)
# ==============================================================================
...
def train_single_fold_ablation(fold_idx, train_weeks, val_weeks, 
    ...
    fold_train_time_minutes = (duration_sess + duration_user + duration_fusion) / 60.0
...
if __name__ == '__main__':
    ...
    # ==============================================================================
    # 💾 TÌM NGƯỠNG TỐI ƯU TRÊN TẬP VAL MIX (BẰNG F1-SCORE)
    # ==============================================================================
    print("\n" + "*"*70)
    print("🎯 ĐANG TỰ ĐỘNG TÌM NGƯỠNG TỐI ƯU DỰA TRÊN F1-SCORE (VAL MIX)...")
    print("*"*70)
    ...
    print(f"📏 Ngưỡng vàng Val Mix tự động tìm được:")
