...
if __name__ == '__main__':
    ...
    def plot_training_history_average(histories):
        ...
        axes[0].plot(avg_history['loss'], label='Train Loss', color='blue', linewidth=1)
        axes[0].plot(avg_history['val_loss'], label='Validation Loss', color='orange', linewidth=1)
        ...
        if 'accuracy' in avg_history:
            axes[1].plot(avg_history['accuracy'], label='Train Accuracy', color='blue', linewidth=1)
            axes[1].plot(avg_history['val_accuracy'], label='Validation Accuracy', color='orange', linewidth=1)
