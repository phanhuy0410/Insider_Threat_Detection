...
def saint_block(inputs, T_dim, F_feat, num_heads=4, key_dim=64, ff_dim=256, dropout=0.1, name_prefix="SAINT"):
...
pos_emb = Embedding(input_dim=n_steps, output_dim=128, name='Session_PosEmb')(positions)
x = x + tf.expand_dims(pos_emb, axis=0)
x = saint_block(inputs=x, T_dim=n_steps, F_feat=128, num_heads=4, key_dim=64, ff_dim=256, dropout=0.2, name_prefix="SAINT_1")
