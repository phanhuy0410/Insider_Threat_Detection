...
# ==============================================================================
# 🤖 TẦNG 2: INDEPENDENT EXPERT (SCEN2 VS BENIGN) - ENCODER MỚI HOÀN TOÀN
# ==============================================================================
def build_full_expert_t2(T_sess, F_sess, F_user, learning_rate=0.0001):
    ...
    x_sess = LSTM(128, return_sequences=True)(x_sess)
    ...
    x_user = LSTM(32, return_sequences=True)(x_user)
...
if __name__ == '__main__':
    ...
    plot_confusion_matrix_percent(conf_matrix_r52, classes_names, title="Ma Trận Nhầm Lẫn Test R5.2 - 2 Stage")
