...
def build_full_expert_t2(T_sess, F_sess, F_user, learning_rate=0.0001):
    """ TẦNG 2: Có toàn bộ LSTM, Attention riêng rẽ, tối ưu cho 2 Class """
    ...
    x_sess = tcn_residual_block(x_sess, n_filters=64, kernel_size=3, dilation_rate=1, dropout_rate=0.3, block_name="Sess_TCN_T2")
    ...
    x_user = tcn_residual_block(x_user, n_filters=32, kernel_size=3, dilation_rate=1, dropout_rate=0.2, block_name="User_TCN_T2")
...
def train_single_fold_ablation(fold_idx, train_weeks, val_weeks, 
    ...
    # ==========================================================================
    # 🚀 HUẤN LUYỆN TẦNG 1 (GENERAL DETECTOR)
    # ==========================================================================
...
if __name__ == '__main__':
    ...
    THRESH_S3 = np.percentile(oof_benign_probs[:, 3], 99.95)
    ...
    plot_confusion_matrix_percent(conf_matrix_r52, classes_names, title="Ma Trận Nhầm Lẫn Test R5.2 - TCN 2 Stage")
