...
def build_session_encoder(T_sess, F_sess, learning_rate=0.0001):
    ...
    x = tcn_residual_block(inp, n_filters=64, kernel_size=3, dilation_rate=1, dropout_rate=0.2, block_name="Sess_TCN_D1")
...
if __name__ == '__main__':
    ...
    THRESH_S2 = np.percentile(oof_benign_probs[:, 2], 99.25)  
    THRESH_S3 = np.percentile(oof_benign_probs[:, 3], 99.996)
